...
char ssid[] = "IoT Project AP"; //*改自己wifi
char pass[] = "88888888";       //*改自己wifi密碼

int status = WL_IDLE_STATUS;
IPAddress server(); //*修改成欲作為伺服器的ip
...
const char *topicPub = "topicPub";  //*修改成自己設定的主題
const char *topicSub = "topicSub"; //*修改成自己訂閱的主題
String strJson = "";
char charJson[100];

const char *topicPubToPhone = "topicPhone";
...
//int pumpStart = 20;
//int buzzerStart = 15;  
//String test = "buzzerStart:"+String(buzzerStart).c_str() ;
...
\n",String(ledStart).c_str(),String(fanStartByHumidity).c_str(),String(pumpStart).c_str() ,String(buzzerStart).c_str(),String(timeStart).c_str(),String(timeEnd).c_str());
    ...
    Serial.print("fanStartByHumidity:");
    Serial.println(fanStartByHumidity);
    Serial.print("pumpStart:");
    Serial.println(pumpStart);
    Serial.print("buzzerStart:");
    Serial.println(buzzerStart);
